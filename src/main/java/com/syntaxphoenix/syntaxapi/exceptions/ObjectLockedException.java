package com.syntaxphoenix.syntaxapi.exceptions;

public class ObjectLockedException extends RuntimeException {

	/**
     * Constructs an <code>ObjectLockedException</code> with no
     * detail message.
     */
    ...
    /**
     * Constructs an <code>ObjectLockedException</code> with the
     * specified detail message.
     *
     * @param   s   the detail message.
     */
    public ObjectLockedException(String s) {
        super(s);
    }
